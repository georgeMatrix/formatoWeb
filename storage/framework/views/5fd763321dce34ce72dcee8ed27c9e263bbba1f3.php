        ...
        <div class="toppanel-left">
            ...
            <div id="layerslider" style="width: 714px; height: 400px;">
                ...
                <div class="ls-slide" data-ls="transition2d: 8,49,111,105; slidedelay: 8000;">
                    ...
                    <!--Slider Background-->
                    <img class="ls-bg" src="images/laptopfw.png" alt="layer1-background" />
                    <a href="#" class="ls-link"></a>

                    <!--Slider Layers-->
                    <img class="ls-l" src="images/mousefw.png" alt="layer image" style="top: 20px; left: 80px;" data-ls="offsetxin: 700; offsetxout: -450; fadein: false; fadeout: false; durationin: 2500; durationout: 1000; easingout : easeInOutBack;" />
                ...
                <div class="ls-slide" data-ls="transition2d: 8,49,111,105; slidedelay: 8000;">
                    ...
                    <!--Slider Background-->
                    <img class="ls-bg" src="images/extremefw.png" alt="layer2-background" />
                    <a href="#" class="ls-link"></a>

                    <!--Slider Layers-->
                    <img class="ls-l" src="images/hddfw.png" alt="layer image" style="top: 80px; left: 355px;" data-ls="offsetxin: 500; offsetxout: 500; fadein: false; fadeout: false; durationin: 2000; durationout: 1000; easingin: easeInOutBack; easingout : easeInOutBack;" />

                    <img class="ls-l" src="images/memoria.png" alt="layer image" style="top: 155px; left: 335px;" data-ls="offsetxin: 580; offsetxout: 580; fadein: false; fadeout: false; durationin: 2500; durationout: 1000; easingin: easeInOutBack; easingout : easeInOutBack;" />
                ...
                <!--Slider Background-->
                <!--<img class="ls-bg" src="images/motherfw.png" alt="layer3-background" />
                <a href="#" class="ls-link"></a>-->
        ...
        <div class="visible-lg visible-md">
            <div class="toppanel-right">
                <div class="home-aboutus">
                    <figure>
                        <img src="images/lap2fw.jpg" alt="Who we are" />
                    </figure>
                </div>
        ...
        <div class="visible-lg visible-md visible-sm">
            ...
            <div class="portfolio-thumbnail">
                <div class="megafolio-container noborder">
                    ...
                    <!--Thumbnail 1 Start-->
                    <div class="mega-entry cat-all cat-one" id="entry-1" data-src="images/sofw.png" data-width="800" data-height="605">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup1">
                            <img src="images/sofw2.png" alt="portfolio" />
                    ...
                    <!--Thumbnail 2 Start-->
                    <div class="mega-entry cat-all cat-one" id="entry-2" data-src="images/limpieza2fw.png" data-width="600" data-height="655">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup2">
                            <img src="images/limpiezafw.png" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Limpieza de CPU y Laptop</h2>
                    ...
                    <!--Thumbnail 3 Start-->
                    <div class="mega-entry cat-all cat-one" id="entry-3" data-src="images/recuperacionfw.png" data-width="800" data-height="536">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup3">
                            <img src="images/recuperacion2.jpg" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Rescate de documentos</h2>
                    ...
                    <!--Thumbnail 4 Start-->
                    <div class="mega-entry cat-all cat-two" id="entry-4" data-src="images/actualizacion2fw.png" data-width="600" data-height="600">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup4">
                            <img src="images/actualizacion1fw.png" alt="portfolio" />
                            <div class="popup-text">
                    ...
                    <!--Thumbnail 5 Start-->
                    <div class="mega-entry cat-all cat-two" id="entry-5" data-src="images/accesoriosfw22.png" data-width="590" data-height="400">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup5">
                            <img src="images/accesoriosfw.png" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Accesorios y Refacciones</h2>
                    ...
                    <!--Thumbnail 6 Start-->
                    <div class="mega-entry cat-all cat-three" id="entry-6" data-src="images/mantenimiento2fw.png" data-width="700" data-height="766">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup6">
                            <img src="images/mantenimientofw1.png" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Mantenimiento</h2>
                                <ul>
                                    <li>Predictivo<br>
                    ...
                    <!--Thumbnail 7 Start-->
                    <div class="mega-entry cat-all cat-four" id="entry-7" data-src="images/usadofw.png" data-width="700" data-height="766">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup7">
                            <img src="images/usado2.png" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Compra y venta de accesorios</h2>
                    ...
                    <!--Thumbnail 9 Start-->
                    <div class="mega-entry cat-all cat-two" id="entry-9" data-src="images/cablesfw.png" data-width="700" data-height="766">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup9">
                            <img src="images/cables2fw.jpg" alt="portfolio" />
                            <div class="popup-text">
                    ...
                    <!--Thumbnail 9 Start-->
                    <div class="mega-entry cat-all cat-one" id="entry-10" data-src="images/tabletfw.png" data-width="700" data-height="766">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup10">
                            <img src="images/touchfw.jpg" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Tablet</h2>
                    ...
                    <!--Thumbnail 10 Start-->
                    <div class="mega-entry cat-all cat-five" id="entry-11" data-src="images/tiendafw.png" data-width="700" data-height="766">
                    ...
                    <div class="popup-wrapper">
                        <div class="content-popup popup11">
                            <img src="images/tienda2_fw.jpg" alt="portfolio" />
                            <div class="popup-text">
                                <h2>Tienda</h2>
                                ...
                                <!--<button onClick="">Mas Detalles</button>-->
                                <a href="tienda" class="btn btn-primary marginBoton" >Mas Detalles</a>
                            </div>
                        </div>
                    </div>
                    <!--Thumbnail End-->
