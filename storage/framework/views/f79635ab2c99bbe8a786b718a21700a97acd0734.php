<?php $__env->startSection('contenido'); ?>
    ...
    <div class="page-title">
        <div class="page-title-detail">
            <h1>Contacto</h1>
            <p class="sub-title">Seccion en desarrollo</p>
        </div>
    ...
    <header class="space-inter">
        <div class="container-flex space-between">
            <!-- <figure class="logo"><img src="blog/img/logo.png" alt=""></figure> -->
    ...
    <section>
        ...
        <article class="post w-image">
            <figure><img src="blog/img/img-post-1.png" alt="" class="img-responsive"></figure>
            <div class="content-post">
                <header class="container-flex space-between">
                    <div class="date">
        ...
        <article class="post w-gallery">
            <div class="gallery-photos masonry">
                <figure class="gallery-image"><img src="blog/img/img-post-gallery-1.png" alt=""></figure>

                <figure class="gallery-image"><img src="blog/img/img-post-gallery-3.png" alt=""></figure>

                <figure class="gallery-image"><img src="blog/img/img-post-gallery-2.png" alt=""></figure>

                <figure class="gallery-image"><img src="blog/img/img-post-gallery-hover.png" alt=""></figure>
            </div>
            <div class="content-post">
                <header class="container-flex space-between">
                    <div class="date">
        ...
        <article class="post cite">
            <div class="content-post">
                ...
                <figure class="img-cite"><img src="blog/img/img-cite.png" alt=""></figure>
        ...
        <article class="post w-slider">
            <figure><img src="blog/img/img-slider-1.png" alt="" class="img-responsive"></figure>
            <div class="content-post">
                <header class="container-flex space-between">
                    <div class="date">
        ...
        <article class="post image-w-text">
            <div class="content-post">
                ...
                <div class="image-w-text-content">
                    <figure class="block-left"><img src="blog/img/img-post-2.png" alt=""></figure>
                    <p>Quisque congue lacus mattis massa luctus, nec hendrerit purus aliquet. Ut ac elementum urna. Pellentesque suscipit metus et egestas congue. Duis eu pellentesque turpis, ut maximus metus. Sed ultrices tellus vitae rutrum congue. Fusce luctus augue id nisl suscipit, vel sollicitudin orci egestas. Morbi posuere venenatis ipsum, ac vestibulum quam dignissim efficitur. Ut vitae rutrum augue, in volutpat quam. Cras a viverra ipsum. Aenean ut consequat ex, vitae vulputate nunc. Vestibulum metus nisi, aliquam sed tincidunt sit amet, pretium et augue.</p>
