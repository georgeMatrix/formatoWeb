...
$factory->define(App\modelos\Provedor::class, function (Faker $faker) {
    return [
        'nombre' => $faker->name,
...
$factory->define(App\modelos\Categoria::class, function (Faker $faker) {
    return [
        'nombre' => $faker->name,
...
$factory->define(App\modelos\UnidadMedida::class, function (Faker $faker) {
    return [
        'nombre' => $faker->name,
        'descripcion' => $faker->name,
    ];
